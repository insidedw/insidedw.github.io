    ...
    <div className="App">
      ...
      <section>
        ...
        <div>
          ...
          <p className={'description'}>FE + BE</p>
          <h4 className={'done'}>상점 페이지 &gt; 메뉴탭 페이지 개발</h4>
          <h4 className={'done'}>메뉴 페이지 개발</h4>

          <p className={'description'}>FE</p>
          <h4 className={'done'}>단풍 시즌 때 단풍 명소 페이지 진입 시 단풍 떨어지는 에니메이션 개발</h4>
          <h4 className={'done'}>상점 페이지 Tab 별 dynamic 로딩 제안</h4>
          <h4 className={'done'}>외부 서비스 제공을 위하여 미디어 뷰어 페이지 개발</h4>
          <h4 className={'done'}>자주 쓰이는 주요 컴포넌트 storybook으로 side effect 최소화</h4>

          <p className={'description'}>BE</p>
          <h4 className={'done'}>Circuit breaker 적용</h4>
          ...
          <p className={'description'}>next.js, nest.js, storybook</p>
        </div>
        <div>
          ...
          <p className={'description'}>FE + BE</p>
          <h4 className={'done'}>지역 X 카테고리 랭킹 API + 페이지 개발</h4>
        ...
        <div>
          ...
          <p className={'description'}>FE</p>
          <h4 className={'done'}>JS, CSS 파일 Static File Server에 올려, 웹 초기 렌더링 속도 향상</h4>
          <p className={'description done secondary'}>Slow 3G 환경, js 로드 시간 감소 (39% 향상)</p>

          <h4 className={'done'}>유료 채팅 페이지 개발</h4>
          <p className={'description done secondary'}>구매 권한 체크를 위해 JWT 사용</p>

          <h4 className={'done'}>이미지 업로더 sdk 교체</h4>
          <p className={'description done secondary'}>
            이미지 업로드 시 BFF에 전달하고 BFF가 이미지 SDK API 호출하여 비효율. BFF 의존성을 제거되고 글로벌 대응도
            가능하게 됨
          </p>

          <h4 className={'done'}>Slow 3G 환경, 3rd party sdk 로드되기전 sdk API 호출되어 404 에러 발생하여 수정</h4>
          <h4 className={'done'}>새소식 UI 개발</h4>
          <h4 className={'done'}>채널 홈 UI 개발</h4>

          <p className={'description'}>BE</p>
          <h4 className={'done'}>쿠키 정책 변경으로 특정 브라우저에서 로그인이 안되었던 이슈 최대한 해결</h4>
          <p className={'description done secondary'}>
            Redis로 유저 정보를 저장하여 인증정보로 엑세스 토큰 제공 (29% 에러 감소)
          </p>
          <h4 className={'done'}>MSA 구조로 검색 API 개편</h4>
        ...
        <div>
          ...
          <p className={'description'}>FE</p>
          <h4 className={'done'}>웹 SPA 적용 (jQuery to React)</h4>
          <h4 className={'done'}>Varnish 서버 설치하여 웹페이지 캐싱하여 비로그인 유저에게 빠르게 서빙</h4>
          <h4 className={'done'}>음원 및 영상 올리는 웹 페이지 개발</h4>
          <h4 className={'done'}>비디오 재생 페이지에 추천 영상 리스트 UI 개발</h4>
          <h4 className={'done'}>마케팅 툴 연동 (Braze, Facebook Pixel, Tune, GA)</h4>

          <p className={'description'}>BE</p>
          <h4 className={'done'}>API, Flume, Kafka, Storm 이용하여 실시간 사용자 엑션에 의한 레벨 증가 시스템 개발</h4>
          <p className={'description done secondary'}>
          ...
          <h4 className={'done'}>Prism Studio 연동</h4>
          <h4 className={'done'}>좋아요 API 개발</h4>
          <h4 className={'done'}>실시간 라이브스트림 시청자 수 API 및 Dashboard 개발</h4>
          <h4 className={'done'}>아티스트 후원 관련 정보 제공 API 개발</h4>
          <h4 className={'done'}>50개 이상 다양한 지표 제공 (Zepplelin via MySql, Hive)</h4>
          <h4 className={'done'}>어뷰징 관련 신고 시 운영자 메일로 전달되는 기능 개발</h4>

          <p className={'description'}>Devops</p>
          <h4 className={'done'}>Ansible 이용하여 인프라 구축 (Static File Server, 운영툴, Redis)</h4>
          <h4 className={'done'}>SSL 인증서 교체</h4>
          <h4 className={'done'}>Apache에서 Nginx로 이관 작업</h4>

          <p className={'description'}>ops</p>
          <h4 className={'done'}>미국 현지에서 라이브스트림 기술 지원</h4>
          <p className={'description done secondary'}>
            안정적인 라이브스트림을 위해 라이브스트림 인프라와 데이터 흐름을 이해하고 장애를 최소화 할 수 있도록 리허설
            및 기술 지원
          </p>
          <p className={'description'}>
        ...
        <div>
          ...
          <p className={'description'}>FE + BE</p>
          <h4 className={'done'}>웹 기반 회사 제품 라이센스 관리 프로그램 개발</h4>
          <h4 className={'done'}>SSO &gt; 중복 로그인 시 기존 로그인이 풀리는 기능 개발</h4>
          <h4 className={'done'}>
            SSO &gt; 세션 클러스터링 가능하도록 개발하여 다수의 에이전트 서버가 설치되어 있는 환경에서도 SSO 인증 처리
            가능
          </h4>
          <h4 className={'done'}>EAM &gt; 유저 속성 기반 권한 관리 아키텍쳐 설계</h4>
          <h4 className={'done'}>OAuth 2.0 기반 IOT 통신 시 인증 및 권한 관리 프로그램 개발 </h4>
          <p className={'description'}>
        ...
        <div>
          ...
          <h4 className={'done'}>Helped customers who have trouble with computer hardware or software.</h4>
          <h4 className={'done'}>Set up network cable on campus</h4>
        </div>
        <div>
          <h3>TEST ENC</h3>
          <p className={'description'}>
          ...
          <h4 className={'done'}>Created test cases. Run functional, regression, and alpha testing.</h4>
        </div>
        <div>
